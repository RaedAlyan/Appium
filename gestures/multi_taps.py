...
check_box2 = driver.find_element(AppiumBy.ACCESSIBILITY_ID, value='Checkbox 2')
check_box1_location = check_box1.location
check_box2_location = check_box2.location
driver.tap([(check_box1_location['x'], check_box1_location['y']),
            (check_box2_location['x'], check_box2_location['y'])])  # Multi-taps using W3C Actions API.
driver.quit()
